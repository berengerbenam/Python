...
def Add():
    ...
    mysqldb=mysql.connector.connect(host="localhost",user="berenger",password="bg236",database="payroll")
...
tk.Label(root, text="CRUD Beerenger !", fg="red", font=(None, 30)).place(x=300, y=5)
